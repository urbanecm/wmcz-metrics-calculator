...
cp ../00_Schema/wmcz_outreach_dashboard_courses_users.hql schema
...
hive -e "SELECT * FROM urbanecm.wmcz_outreach_dashboard_courses_users" > wmcz_outreach_dashboard_courses_users.txt
